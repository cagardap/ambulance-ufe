...
import { AmbulanceWaitingListApiFactory, WaitingListEntry, AmbulanceConditionsApiFactory, Condition } from '../../api/ambulance-wl';

@Component({
  tag: 'pc-ambulance-wl-editor',
  styleUrl: 'pc-ambulance-wl-editor.css',
  shadow: true,
})
export class PcAmbulanceWlEditor {
  @Prop() entryId: string;
