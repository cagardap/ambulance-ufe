...
import { PcAmbulanceWlEditor } from '../pc-ambulance-wl-editor';
...
describe('pc-ambulance-wl-editor', () => {
  ...
  it('buttons shall be of different type', async () => {
     ...
     const page = await newSpecPage({
        components: [PcAmbulanceWlEditor],
        html: `<pc-ambulance-wl-editor entry-id="test-entry"
  ...
  it('first text field is patient name', async () => {
     ...
     const page = await newSpecPage({
        components: [PcAmbulanceWlEditor],
        html: `<pc-ambulance-wl-editor entry-id="test-entry" ambulance-id="test-ambulance" api-base="http://sample.test/api"></pc-ambulance-wl-editor>`,
     });
